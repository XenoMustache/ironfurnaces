...
import static com.xenomustache.ironfurnaces.blocks.BlockGlassFurnace.FACING;

import com.xenomustache.ironfurnaces.ModConfig;

public class TileEntityGlassFurnace extends TileEntityLockable implements ITickable, ISidedInventory {
    ...
    public static void registerFixesFurnace(DataFixer fixer) {
        fixer.registerWalker(FixTypes.BLOCK_ENTITY, new ItemStackDataLists(TileEntityGlassFurnace.class, new String[]{"Items"}));
    }
    ...
    public String getName() {
        return this.hasCustomName() ? this.furnaceCustomName : "container.furnace_" + 3;
    }
    ...
    public int getCookTime(ItemStack stack) {
        return ModConfig.CrystalFunraceCookTime;
    }
