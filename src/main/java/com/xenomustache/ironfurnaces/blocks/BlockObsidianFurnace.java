...
import static com.xenomustache.ironfurnaces.tileentity.TileEntityObsidianFurnace.keepInventory;
...
public class BlockObsidianFurnace extends BlockContainer {
    ...
    public BlockObsidianFurnace(String name, boolean isBurning) {
        super(Material.ROCK);
    ...
    @Override
    public BlockObsidianFurnace setCreativeTab(CreativeTabs tab) {
        if (isBurning == false) {
