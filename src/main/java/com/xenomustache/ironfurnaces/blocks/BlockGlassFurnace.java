...
import static com.xenomustache.ironfurnaces.tileentity.TileEntityGlassFurnace.keepInventory;
...
public class BlockGlassFurnace extends BlockContainer {
    ...
    public BlockGlassFurnace(String name, boolean isBurning) {
        super(Material.ROCK);
    ...
    @Override
    public BlockGlassFurnace setCreativeTab(CreativeTabs tab) {
        if (isBurning == false) {
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune) {
        return Item.getItemFromBlock(IFBlocks.glassFurnaceIdle);
    }
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack) {
        ...
        if (stack.hasDisplayName()) {
            ...
            if (tileentity instanceof TileEntityGlassFurnace) {
                ((TileEntityGlassFurnace) tileentity).setCustomInventoryName(stack.getDisplayName());
            }
        }
    }
    ...
    public void breakBlock(World worldIn, BlockPos pos, IBlockState state)
    {
        if (!keepInventory)
        {
            ...
            if (tileentity instanceof TileEntityGlassFurnace)
            {
                InventoryHelper.dropInventoryItems(worldIn, pos, (TileEntityGlassFurnace)tileentity);
