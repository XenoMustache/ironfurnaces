...
public class BlockModFurnace extends BlockContainer {
    ...
    public BlockModFurnace(String name, int materialID, boolean isBurning) {
        super(Material.ROCK);
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
        if (worldIn.isRemote) {
            ...
            if (tileentity instanceof TileEntityModFurnace) {
                playerIn.displayGUIChest((TileEntityModFurnace) tileentity);
    ...
    public TileEntity createNewTileEntity(World worldIn, int meta) {
        return new TileEntityModFurnace(materialID);
    }
